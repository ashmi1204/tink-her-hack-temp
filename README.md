...
**Tool Used:** :GitHub ,Gemini,ChatGPT, Claude 

**Purpose:**
-Code Debugging
-Generating code for implementing the Functions
...
- Ashmi Prakash: Backend development,Backend Integration
- Ann Susan Jose: Frontend development, Protoype Design
